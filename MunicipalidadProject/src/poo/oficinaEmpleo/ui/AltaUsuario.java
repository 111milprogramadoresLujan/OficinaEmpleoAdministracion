 ...
 */
package poo.oficinaEmpleo.ui;

import javax.swing.JOptionPane;
import poo.oficinaEmpleo.controller.GestorOficanaEmpleo;
...
public class AltaUsuario extends javax.swing.JFrame {
    ...
    private final GestorOficanaEmpleo gestor;
    /**
     * Creates new form AltaUsuario
     */
    public AltaUsuario(GestorOficanaEmpleo gestor) {
    ...
    public void GuardarAltaUsuario()
    {
      ...
      if (nombre.isEmpty() || apellido.isEmpty() || nombreUsuario.isEmpty() || email.isEmpty() || contraseña.length()  < 1 || confirmarcontraseña.length() < 1) {
        ...
        if (!String.valueOf(contraseña).equals(String.valueOf(confirmarcontraseña))) {
         ...
         if(!gestor.isUsuarioExistente(txtnombreusuario.getText())){
        ...
        if (gestor.GuardarUsuario(nombre, apellido, email, contraseña, nombreUsuario)) {
            JOptionPane.showMessageDialog(null, "Te has registrado correctamente!", "Información", JOptionPane.INFORMATION_MESSAGE);
        } else {
